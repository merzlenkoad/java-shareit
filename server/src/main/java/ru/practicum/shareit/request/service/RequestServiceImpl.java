...
public class RequestServiceImpl implements RequestService {
    ...
    public ItemRequestDto create(ItemRequestShortDto itemRequestShortDto, Long userId) {
        ...
        return requestMapper.toItemRequestDto(requestRepository.save(itemRequest),
                itemRepository.findByRequestIdOrderByIdDesc(itemRequest.getId()));
    }
    ...
    public List<ItemRequestDto> getByUserId(Long userId) {
        ...
        return  itemRequests.stream().map(itemRequest -> requestMapper.toItemRequestDto(itemRequest,
                itemRepository.findByRequestIdOrderByIdDesc(itemRequest.getId()))).collect(Collectors.toList());
    }
